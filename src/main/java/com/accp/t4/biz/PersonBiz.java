...
public class PersonBiz {
	...
	public PageInfo<Person> findPersonListByPage2(Integer pageNum, Integer pageSize,String pid,String pname) {
		PageHelper.startPage(pageNum, pageSize);
		return new PageInfo<Person>(personDao.queryPerson2(pid,pname));
	}
	...
	public void modifyPerson(Person person) {
		/*
		 * personDao.deletePerson(person.getPid()); personDao.savePerson(person);
		 */
		personDao.updatePerson(person);
	}

	public void addPerson(Pc person) {
