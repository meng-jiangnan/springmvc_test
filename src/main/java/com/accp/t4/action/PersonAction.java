...
public class PersonAction {
	...
	@GetMapping("cx/{num}/{size}/{pid}/{pname}")
	public PageInfo<Person> getPersonListByPage2(@PathVariable Integer num, @PathVariable Integer size,@PathVariable String pid,@PathVariable String pname) {
		return personBiz.findPersonListByPage2(num, size,pid,pname);
	}
	...
	@PostMapping("person")
	public Map<String, String> addPersonInfo(@RequestBody Pc person) {
		Map<String, String> message = new HashMap<String, String>();
